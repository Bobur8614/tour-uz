...
public interface IUserService extends IAbstractService {
    ...
    ResponseEntity<DataDto<UserDetailsDto>> get(Long id);
    ...
    ResponseEntity<DataDto<UserDetailsDto>> update(@NotNull UserUpdateDto dto);

    ResponseEntity<DataDto<Boolean>> delete(@NotNull Long id);

    ResponseEntity<DataDto<UserDetailsDto>> attachRolesToUser(@NotNull AttachRoleDto dto);
