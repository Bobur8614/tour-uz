...
public class RoleService implements IRoleService {
    ...
    @Autowired
    public RoleService(RoleDao roleDao, RoleMapper roleMapper, GenericMapper genericMapper, BaseUtils utils, IGeneralRepository generalRepository, IActivityService activityService) {
...
//    @PreAuthorize("hasPermission(null, T(uz.com.enums.Permissions).ROLE_READ)")
    public ResponseEntity<DataDto<List<RoleDto>>> getAll(RoleCriteria criteria) {
        ...
        Stream<Role> stream = roleDao.listStream(criteria);
...
//    @PreAuthorize("hasPermission(null, T(uz.com.enums.Permissions).ROLE_CREATE)")
    public ResponseEntity<DataDto<GenericDto>> create(@NotNull RoleCreateDto dto) {
        ...
        map.put("objectId", role.getId().toString());
        activityService.saveRole(map);
