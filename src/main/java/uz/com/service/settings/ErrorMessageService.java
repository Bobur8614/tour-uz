...
//    private final Log logger = LogFactory.getLog(getClass());
    ...
    public ErrorMessageService(GenericMapper genericMapper, ErrorMessageDao errorMessageDao, ErrorMessageMapper errorMessageMapper, BaseUtils utils, LanguageMapper languageMapper) {
    ...
    public ResponseEntity<DataDto<List<ErrorMessageDto>>> getAll(ErrorMessageCriteria criteria) {
        ...
        Stream<ErrorMessage> stream = errorMessageDao.listStream(criteria);
